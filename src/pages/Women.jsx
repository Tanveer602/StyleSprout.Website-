...
export default function Women({ addToCart }) {
  ...
  const categories = ["All", ...new Set(womenProducts.map(product => product.category || "Women"))];
  ...
  useEffect(() => {
    ...
    if (selectedCategory !== "All") {
      results = results.filter(product =>
        (product.category || "Women") === selectedCategory
      );
    }
  ...
  return (
    <div className="men-page">
      ...
      <div className="page-header">
        ...
        <p className="page-subtitle">Discover our premium collection of women's fashion</p>
      </div>
                ...
                <li key={category}>
                  ...
                  >
                    ...
                    <span className="category-count">
                      ({category === "All" ? womenProducts.length : 
                        womenProducts.filter(p => (p.category || "Women") === category).length})
                    </span>
                  </button>
                </li>
              ))}
          ...
          <div className="products-toolbar">
            <div className="toolbar-left">
              <p className="products-count">
                Showing <strong>{filteredProducts.length}</strong> of <strong>{womenProducts.length}</strong> products
              </p>
            </div>
              ...
              filteredProducts.map((product) => (
                <div className="product-item" key={product.id}>
                  ...
                  <div className="product-info">
                    <div className="product-category">{product.category || "Women"}</div>
            ...
            <div className="modal-content">
              ...
              <div className="product-details-modal">
                ...
                <div className="description">
                  <p>{currentProduct.description || "High-quality women's product. Comfortable, durable, and stylish."}</p>
                </div>
                ...
                <div className="product-meta-info">
                  <div className="meta-item">
                    ...
                    <span className="meta-value">{currentProduct.category || "Women"}</span>
                  </div>
                  <div className="meta-item">
                    <span className="meta-label">Tags:</span>
                    <span className="meta-value">Fashion, Women, Clothing</span>
                  </div>
                </div>
              </div>
            </div>
