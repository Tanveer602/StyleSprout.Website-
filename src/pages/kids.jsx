...
export default function Kids({ addToCart }) {
  ...
  const categories = ["All", ...new Set(kidsProducts.map(product => product.category || "Kids"))];

  useEffect(() => {
    let results = [...kidsProducts];
    ...
    if (selectedCategory !== "All") {
      results = results.filter(product =>
        (product.category || "Kids") === selectedCategory
      );
    }
  ...
  return (
    <div className="men-page">
      ...
      <div className="page-header">
        ...
        <p className="page-subtitle">Discover our premium collection for kids</p>
      </div>
                ...
                <li key={category}>
                  ...
                  >
                    ...
                    <span className="category-count">
                      ({category === "All" ? kidsProducts.length : 
                        kidsProducts.filter(p => (p.category || "Kids") === category).length})
                    </span>
                  </button>
                </li>
              ))}
          ...
          <div className="products-toolbar">
            <div className="toolbar-left">
              <p className="products-count">
                Showing <strong>{filteredProducts.length}</strong> of <strong>{kidsProducts.length}</strong> products
              </p>
            </div>
              ...
              filteredProducts.map((product) => (
                <div className="product-item" key={product.id}>
                  ...
                  <div className="product-info">
                    <div className="product-category">{product.category || "Kids"}</div>
            ...
            <div className="modal-content">
              ...
              <div className="product-details-modal">
                ...
                <div className="description">
                  <p>{currentProduct.description || "High-quality kids product. Comfortable, durable, and stylish."}</p>
                </div>
                ...
                <div className="product-meta-info">
                  <div className="meta-item">
                    ...
                    <span className="meta-value">{currentProduct.category || "Kids"}</span>
                  </div>
                  <div className="meta-item">
